...
function MainSection() {
  return (
    <div className='main-section flex flex-1 grow justify-center px-8 pt-1'>
      <div className='mt-2 flex w-[550px] flex-col items-center rounded-2xl border border-trueGray-800 bg-trueGray-800'>
        <div className='main-section__options relative flex h-[72px] w-full border-b-2 border-trueGray-700'>
          <div
            className='ml-3 mr-1 flex w-full py-1'
            style={{
              borderBottom: "3.5px solid #3B82F6",
            }}
          >
            <div className='stories flex h-full w-full cursor-pointer items-center justify-center rounded-lg hover:bg-trueGray-700'>
              <ImportContactsSharp
          ...
          <div className='reels my-1 mr-3 ml-1 flex w-full cursor-pointer items-center justify-center rounded-lg pr-1 hover:bg-trueGray-700'>
            <MovieFilterSharp
